  ...
  const uploadImage = (e) => {
    ...
    uploadTask.on(
      ...
      (error) => {
        console.log(error);
        setFields(true);
        setMsg("Ошибка загрузки : Попробуй снова 🙇");
      ...
      () => {
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
          ...
          setIsLoading(false);
          setFields(true);
          setMsg("Изображение успешно загружено 😊");
  ...
  const deleteImage = () => {
    ...
    deleteObject(deleteRef)
      ...
      .catch((error) => {
        console.log(error);
        setFields(true);
        setMsg("Ошибка при удалении : Попробуй снова 🙇");
        setAlertStatus("danger");
        setTimeout(() => {
          setFields(false);
          setIsLoading(false);
