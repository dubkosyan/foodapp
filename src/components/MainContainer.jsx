...
const MainContainer = () => {
  ...
  return (
    <AnimatePresence>
      <div className="w-full h-full flex flex-col items-center justify-start rounded-full padding-left:8rem">
        {/* Hero section */}
        ...
        >
          Жизнь слишком коротка, <span className="block">чтобы есть невкусную еду!</span>
        </motion.p>
        <motion.p
          initial={{ opacity: 0, y: 200 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Три слова, которое мечтает услышать женщина: «Никакой готовки сегодня».
          Порадуй свою женщину, закажи у нас!
        </motion.p>
